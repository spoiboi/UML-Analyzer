...
## Acknowledgements
We used real sample SQL schema from other projects by the developers (1), sample-files.com (2), and Oracle (3) for authenticity. This was gathered from public sources for realism.